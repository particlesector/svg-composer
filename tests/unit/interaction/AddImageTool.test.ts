...
describe('AddImageTool', () => {
  ...
  describe('pointer events', () => {
    ...
    describe('onPointerDown', () => {
      it('should delegate to onMouseDown for single pointer when ready', () => {
        addImageTool.setConfig({ src: 'test.png' });
        addImageTool.activate();
        ...
        const result = addImageTool.onPointerDown(
      ...
      it('should return false for single pointer when not ready', () => {
        addImageTool.activate();
        const activePointers = new Map([
          [
            1,
